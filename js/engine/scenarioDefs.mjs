export const scenarioDefs = {
  ...
  browser_default_big: {
    ...
    browserConfig: {
      ...
      FLUID_FADE_RATE: 0.001,
      LANDSCAPE_DYE_EMITTERS_ENABLED: true,
      LANDSCAPE_DYE_EMITTER_COUNT: 220,
      LANDSCAPE_DYE_EMITTER_STRENGTH_MIN: 120,
      LANDSCAPE_DYE_EMITTER_STRENGTH_MAX: 260,
      LANDSCAPE_DYE_EMITTER_RADIUS_CELLS: 2,
      LANDSCAPE_VELOCITY_EMITTERS_ENABLED: true,
      LANDSCAPE_VELOCITY_EMITTER_COUNT: 220,
      LANDSCAPE_VELOCITY_EMITTER_STRENGTH_MIN: 0.8,
      LANDSCAPE_VELOCITY_EMITTER_STRENGTH_MAX: 2.4,
      LANDSCAPE_VELOCITY_EMITTER_RADIUS_CELLS: 3,
      LANDSCAPE_VELOCITY_EMITTER_LOCAL_SPEED_CAP: 0.7,
      LANDSCAPE_VELOCITY_EMITTER_BUDGET_MAX: 2.2,
      LANDSCAPE_VELOCITY_EMITTER_BUDGET_REFILL_PER_SEC: 0.35,
      MIN_VISCOSITY_MULTIPLIER: 0.1,
      MAX_VISCOSITY_MULTIPLIER: 12.0,
      VISCOSITY_LANDSCAPE_CONTRAST: 0.9,
      VISCOSITY_LANDSCAPE_BANDS: 12,
      FLUID_GRID_SIZE_CONTROL: 512,
      FLUID_STEP_EVERY_N_TICKS: 4,
      FLUID_FORCE_FULL_DOMAIN: true,
      FLUID_MOMENTUM_ONLY_STEP_EVERY_N_TICKS: 4,
      FLUID_EMPTY_STEP_EVERY_N_TICKS: 24,
      FLUID_MOMENTUM_ACTIVITY_SPEED_THRESHOLD: 0.0008,
