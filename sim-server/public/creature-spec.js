    ...
    if (rigidField && softField) {
      out.authoring = {
        fields: {
          ...
          softEdgeVelocityModeMap: softEdgeVelocityModeMap ? Array.from(softEdgeVelocityModeMap) : undefined,
          rigidEdgeVelocityModeMap: rigidEdgeVelocityModeMap ? Array.from(rigidEdgeVelocityModeMap) : undefined,
